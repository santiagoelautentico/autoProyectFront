...
btnAgregar.addEventListener("click", () => {
    ...
    if (!marca || !modelo || !condicion || !año || !color || !precio || !imagen || !imagen2 || !imagen3 || !imagen4 || !imagen5 || !planDePago || !motor || !puertas || !Kilometros || !NumeroDePlazas || !PapelesAlDia || !tipoDeCaja ||!combustible || !acercaDelAuto) {
        imprimir("lista-error", "Todos los campos son obligatorios");
        return;
    };

    const body = JSON.stringify({ marca, modelo, condicion, año, color, precio, imagen, imagen2, imagen3, imagen4, imagen5, planDePago, motor, puertas, Kilometros, NumeroDePlazas, PapelesAlDia, tipoDeCaja,combustible, acercaDelAuto });
